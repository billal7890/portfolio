...
const DEFAULT_RESUME_FILE = "assets/BILLAL_RESUME.pdf";
...
const defaultProjects = [
  {
    ...
    details: "The project was motivated by a practical career question: how can I communicate a multidisciplinary background in accounting, finance, business analytics, simulation, visualization, operations, and student leadership without overwhelming the viewer? I planned the site around progressive detail: concise summaries first, followed by complete reports when a visitor chooses See More. The build includes responsive navigation, reusable project and blog data, detailed report pages with balanced image and text layouts, project likes, interaction tracking, downloadable resume management, contact workflow, portfolio analytics dashboard, supporting evidence files, and a locally managed Admin dashboard. A major challenge was preserving a consistent futuristic business-analytics theme while keeping the content readable, professional, and easy to update. The result is a working portfolio that demonstrates both my completed work and my ability to plan, evaluate, and improve a digital product through iterative collaboration.",
    findings: "The development process showed that a strong portfolio is an information-design problem as much as a coding project. Clear hierarchy, consistent spacing, concise summaries, and deeper optional reports make a large amount of experience easier to navigate. AI-assisted development was most useful when paired with clear direction, source material, critical review, and hands-on testing against the visitor experience.",
    recommendations: "The next phase is to publish the site through GitHub Pages, connect the contact and analytics features to production-ready backend services, replace localStorage authentication with secure server-side authentication, and continue measuring which content visitors engage with most. Future releases can also include an accessible content-management backend, automated deployment, richer embedded analytics dashboards, and stronger integration with GitHub-hosted project evidence.",
